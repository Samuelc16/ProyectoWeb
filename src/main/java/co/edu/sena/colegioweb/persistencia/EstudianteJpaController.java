...
import co.edu.sena.colegioweb.persistencia.exceptions.PreexistingEntityException;
...
public class EstudianteJpaController implements Serializable {
    ...
    public EstudianteJpaController() {
        emf=Persistence.createEntityManagerFactory("ejemplo_PU");
    }
